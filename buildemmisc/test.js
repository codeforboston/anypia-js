...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 17408,
    DYNAMIC_BASE = 5260288,
    DYNAMICTOP_PTR = 17248;
...
var _GetAge = Module["_GetAge"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GetAge"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _GetMonths = Module["_GetMonths"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GetMonths"].apply(null, arguments)
};
