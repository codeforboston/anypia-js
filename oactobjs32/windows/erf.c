// $Id: erf.c 1.3 2009/01/13 08:47:49EST 729915 Development  $
//
// Supplies the erf function on NT.
//
// ====================================================
...
#define __ieee754_exp( double ) exp( double )
...
/// <summary>Returns the error function at x.</summary>
///
/// <returns>The error function at x.</returns>
///
/// <param name="x">Value at which error function value is desired.</param>
double erf( double x )
{
	int32_t hx,ix,i;
...
/// <summary>Returns 1 minus the error function at x.</summary>
///
/// <returns>1 minus the error function at x.</returns>
///
/// <param name="x">Value at which 1 minus error function value is desired.
/// </param>
double erfc( double x )
{
	int32_t hx,ix;
